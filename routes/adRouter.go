...
func AdRoutes(incomingRoutes *gin.Engine) {
	...
	incomingRoutes.POST("ads/get_bunkie", controller.GetBunkieAd())
	...
	incomingRoutes.POST("ads/get_room_ad", controller.GetRoomAd())
	incomingRoutes.POST("ads/get_room_ads", controller.GetRoomAds())
